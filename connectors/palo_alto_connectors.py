...
def get_physical_interfaces(username,
    ...
    ----------
    result : dict
        A dictionary containing the command output table, where the keys
        are the devices and the value is a dictionary containing the
        command output for that device.
