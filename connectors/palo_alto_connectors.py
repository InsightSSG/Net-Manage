...
def get_physical_interfaces(username,
                            ...
                            play_path,
                            private_data_dir):
    """Gets the output of the 'show interface hardware' command.
    ...
    result : dict
        ...
        devices and the value is a dictionary containing the command
    ...
    playbook = f'{play_path}/palo_alto_get_physical_interfaces.yml'
    runner = ansible_runner.run(private_data_dir=private_data_dir,
                                playbook=playbook,
                                extravars=extravars,
                                suppress_env_files=True)
...
def get_logical_interfaces(username,
                           ...
                           play_path,
                           private_data_dir):
    """Gets the output of the 'show interface logical' command.
    ...
    playbook = f'{play_path}/palo_alto_get_logical_interfaces.yml'
    runner = ansible_runner.run(private_data_dir=private_data_dir,
                                playbook=playbook,
                                extravars=extravars,
                                suppress_env_files=True)
