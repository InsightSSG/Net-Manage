...
def test_inventory(username,
    ...
    df_inventory = palo_alto_collectors.inventory(username,
                                                  password,
                                                  host_group,
                                                  netmanage_path,
                                                  private_data_dir)
    ...
    assert set(df_inventory.columns.to_list()) == set(expected_with_vms) \
...
def main():
    ...
    # Account for paths that begin with '~'.
    netmanage_path = os.path.expanduser(netmanage_path)
